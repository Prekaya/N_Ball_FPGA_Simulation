...
HD_PWD='C:/Users/Nana/6111Projects/Balls_col2/Balls_col2.runs/frame_blk_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frame_blk_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frame_blk_mem.tcl
