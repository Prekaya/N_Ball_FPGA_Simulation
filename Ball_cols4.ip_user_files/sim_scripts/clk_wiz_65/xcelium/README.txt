...
#
# Generated by export_simulation on Tue Dec 07 23:01:07 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_65.sh' script.

./clk_wiz_65.sh -reset_run
...
./clk_wiz_65.sh -noclean_files

For more information on the script, please type './clk_wiz_65.sh -help'.
